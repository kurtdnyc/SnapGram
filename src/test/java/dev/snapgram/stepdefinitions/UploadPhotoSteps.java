...
public class UploadPhotoSteps {
	...
	public void user_enters_valid_username_into_username_field() throws Throwable {
		...
		loginPage.username.sendKeys("tebow15");
	}
	...
	public void user_enters_valid_password_into_password_field() throws Throwable {
		...
		loginPage.password.sendKeys("tbow");
	}
	...
	public void user_selects_photo_from_computer_to_upload() throws Throwable {
		addPhotoPage.uploadPhotoBtn.sendKeys("C:\\Users\\Mnaum\\Desktop\\project2_images\\tebowPumped.jfif");
	}

	@When("^enters name for photo$")
	public void enters_name_for_photo() throws Throwable {
	    addPhotoPage.photoNameField.sendKeys("Hyped");
	}

	@When("^enters descrption of photo$")
	public void enters_descrption_of_photo() throws Throwable {
	    addPhotoPage.captionField.sendKeys("Getting pumped up!");
	}
	...
	public void image_with_should_have(String arg1, String arg2) throws Throwable {
		Thread.sleep(300);
		String expectedTag = "#" + arg2;
	    assertEquals(arg1, homePage.firstImageTitle.getText());
	    List<WebElement> tags = driver.findElements(By.id("tagSpan"));
	    for(WebElement tag : tags) {
	    	if(expectedTag.equals(homePage.firstTag.getText())) {
	    		assertEquals(expectedTag, homePage.firstTag.getText());
	    	}
	    }
	}
